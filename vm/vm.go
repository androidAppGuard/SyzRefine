...
func Create(cfg *mgrconfig.Config, debug bool) (*Pool, error) {
	...
	// Annotation: call the func Ctor in /data/ghui/phd2/experiment_code/syzkaller_new/vm/qemu/qemu.go
...
func (pool *Pool) Create(index int) (*Instance, error) {
	...
	// Annotation: run a qemu instance => implementation in vm/qemu/qemu.go 
...
func (inst *Instance) Run(timeout time.Duration, reporter *report.Reporter, command string, opts ...any) (
	...
	//Annotation: each inst start will execute this function for ever
